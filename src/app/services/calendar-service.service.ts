...
export class CalendarServiceService {
  ...
  initialize() {
    ...
    this.nextnextMonth = new Date(
      this.currentMonth.getFullYear(),
      this.currentMonth.getMonth() + 2,
      1
    );
    this.currentMonthDates = this.getDatesArray(
      this.currentMonthDates,
      this.currentMonth
    );
    this.nextMonthDates = this.getDatesArray(
      this.nextMonthDates,
      this.nextMonth
    );
    this.nextnextMonthDates = this.getDatesArray(
      this.nextnextMonthDates,
      this.nextnextMonth
    );
  }
}
